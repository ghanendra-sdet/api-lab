    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div
          ...
          className="relative w-80 rounded-md bg-white p-4 shadow-lg dark:bg-neutral-900"
        >
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div
        ...
        className="relative w-80 rounded-md bg-white p-4 shadow-lg dark:bg-neutral-900"
      >
        <h2 className="mb-3 text-sm font-semibold text-neutral-800 dark:text-neutral-100">Save Request</h2>

        <label className="mb-1 block text-xs font-medium text-neutral-500 dark:text-neutral-400" htmlFor="save-name">
          Name
        </label>
        <input
          id="save-name"
        ...
        <label className="mb-1 block text-xs font-medium text-neutral-500 dark:text-neutral-400" htmlFor="save-collection">
          Collection
        </label>
        <select
          id="save-collection"
        ...
        <label className="mb-1 block text-xs font-medium text-neutral-500 dark:text-neutral-400" htmlFor="save-folder">
          Folder (optional)
        </label>
        <select
          id="save-folder"
